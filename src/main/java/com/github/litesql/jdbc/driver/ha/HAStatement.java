...
public class HAStatement extends AbstractJdbcStatement<HAConnection> {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {    	
        executionResult = connection.getClient().executeQuery(sql, parameters);
        return getResultSet();
    }
    ...
    protected int executeUpdate(@NotNull String sql, @Nullable int[] columnIndexes, @Nullable String[] columnNames, int autoGeneratedKeys) throws SQLException {
    	this.updateCount = connection.getClient().executeUpdate(sql, parameters);
    ...
    public long executeLargeUpdate() throws SQLException {
    	this.updateCount = connection.getClient().executeUpdate(queryText, parameters);
        return this.updateCount;
    }
